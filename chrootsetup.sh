...
#Chroot Install
        pacman -Syyu --noconfirm linux-zen linux-lts linux-lts-headers linux-zen-headers nano openssh linux-firmware networkmanager wpa_supplicant wireless_tools netctl dialog lvm2 htop fwupd alsa-utils alsa-plugins pipewire pipewire-alsa
	while true; do
